                ...
                using (SqliteConnection cn = new SqliteConnection(connString))
                {
                    try
                    {
                        string query = $"INSERT INTO {table}(startTime,endTime,description,dayOfWeek,createdAt,modelPersonFamilyId,modelPictureActivityId) " +
                            ...
                            $"('18:00:00', '19:00:00', 'Wspolne zabawy', 1, CURRENT_TIMESTAMP, 1, 16)," +
                            $"('18:00:00', '19:00:00', 'Wspolne zabawy', 3, CURRENT_TIMESTAMP, 1, 16)," +
                            $"('8:30:00', '9:00:00', 'Czas na sniadanko', 1, CURRENT_TIMESTAMP, 5, 18)," +
                            $"('19:00:00', '19:30:00', 'Czas na kolacje', 1, CURRENT_TIMESTAMP, 5, 17)," +
                            $"('19:00:00', '19:30:00', 'Czas na kolacje', 2, CURRENT_TIMESTAMP, 5, 17)," +
                            $"('19:00:00', '19:30:00', 'Czas na kolacje', 3, CURRENT_TIMESTAMP, 5, 17)," +
                    ...
                    try
                    {
                        string query = $"INSERT INTO {table}(activityName,picture) " +
                            $"VALUES (1,'https://images.unsplash.com/photo-1600585152220-90363fe7e115?q=80&w=2070&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D')," +
                                   ...
                                   $"(17,'https://images.unsplash.com/photo-1608835291093-394b0c943a75?q=80&w=2072&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D')," +
                                   $"(18,'https://images.unsplash.com/photo-1504754524776-8f4f37790ca0?q=80&w=2070&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D')," +
                                   $"(19,'https://images.unsplash.com/photo-1606474226448-4aa808468efc?q=80&w=1990&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D');";
                        cn.Open();
                        using (SqliteCommand cmd = new SqliteCommand(query, cn))
                        {
