...
namespace FamilyActivity.WebMvc.Contexts
{
    public class SeedActivityOrder
    {
        public static async Task SeedActiviesOrders(WorkOrderDbContext context, ApplicationContext contextActivity)
        {
            ...
            SetWork(context, contextActivity, today, Enums.PersonFamily.TATA, Enums.ActivityName.Pranie, "#6aa84f");
            SetWork(context, contextActivity, today, Enums.PersonFamily.TATA, Enums.ActivityName.Obiad, "#6aa84f");
            ...
            SetWork(context, contextActivity, today, Enums.PersonFamily.MAMA, Enums.ActivityName.Pranie, "#3F85A4");
            SetWork(context, contextActivity, today, Enums.PersonFamily.MAMA, Enums.ActivityName.Obiad, "#3F85A4");
